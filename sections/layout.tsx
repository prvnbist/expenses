      ...
      () => [
         {
            ...
            title: 'Dashboard',
            href: `/dashboard`,
            isActive: router.asPath.startsWith('/dashboard'),
         },
         {
            icon: <Icon.File tw="stroke-current" />,
            title: 'Transactions',
            href: `/transactions`,
            isActive: router.asPath.startsWith('/transactions'),
         },
         {
            icon: <Icon.DollarSign tw="stroke-current" />,
            title: 'Accounts',
            href: `/accounts`,
            isActive: router.asPath.startsWith('/accounts'),
         },
         {
            icon: <Icon.Group tw="stroke-current" />,
            title: 'Groups',
            href: `/groups`,
            isActive: router.asPath.startsWith('/groups'),
         },
         {
            title: 'Categories',
            href: `/settings/categories`,
            icon: <Icon.Tag tw="stroke-current" />,
            isActive: router.asPath.startsWith('/settings/categories'),
         },
         {
            title: 'Payment Methods',
            href: `/settings/payment-methods`,
            icon: <Icon.Account tw="stroke-current" />,
            isActive: router.asPath.startsWith('/settings/payment-methods'),
         },
      ],
      [router.asPath, user]
   )
